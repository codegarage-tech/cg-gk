...
public class NetworkImageView extends ImageView {
	...
	public void setImageUrl(String url, ImageLoader imageLoader) {
		...
		if (mImageLoader.getPlaceHolderView() != null) {
				...
				new ImageListener() {
					...
					public void onErrorResponse(VolleyError error) {
						...
						if (mErrorImageId != 0) {
							setBackgroundResource(0);
							if (mImageLoader.getPlaceHolderView() != null) {
								mImageLoader.getPlaceHolderView()
	...
	private void ini(Context context, AttributeSet attrs) {
		final TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.customVolley);
		d = a.getDrawable(R.styleable.customVolley_android_background);
		if (d != null) {
			setImageDrawable(d);
		}
	}
